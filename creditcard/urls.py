...
urlpatterns = [
    ...
    # 用户冻结卡 http://127.0.0.1:8000/api/frozen_card?account_id=1&password=123
    path('pay_to', views.pay_to),
    # 用户支付 http://127.0.0.1:8000/api/pay_to?account_in_id=1&account_out_id=2&amount=1000&password=123
    path('show_month_bill', views.show_month_bill),
    # 用户查看月账单 http://127.0.0.1:8000/api/show_month_bill?account_id=1&year=2024&month=5
    path('update_limit', views.update_limit),
    # 用户更新信用卡余额 http://127.0.0.1:8000/api/update_limit?account_id=1&amount=2000&password=123
    ...
    # http://127.0.0.1:8000/api/repay?account_id=2&amount=200&pay_account=3&pay_password
    path('lost_card', views.lost_card),
    # 挂失卡 http://127.0.0.1:8000/api/lost_card?account_id=1&password=123
